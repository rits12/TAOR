...
preload.prototype = {
  preload: function() {
    ...
    // audio
    game.load.audio('music', ['assets/sounds/WAV_TR_07_RETROWAVE_LOOP_03.wav']);
...
playGame.prototype = {
  ...
  addDecorations: function() {
    ...
    this.banner_coke_group.callAll("animations.add", "animations", "banner-coke", Phaser.Animation.generateFrameNames('banner-coke-', 1, 3, '', 0), 30, true);
...
Player = function(game, x, y) {
  ...
  this.initX = x;
  this.initY = y;
  Phaser.Sprite.call(this, game, x, y, "atlas", "idle-0");
  ...
  // add animations
  var animVel = 12;
  this.animations.add('idle', Phaser.Animation.generateFrameNames('idle-', 0, 2, '', 0), animVel - 4, true);
  this.animations.add('run', Phaser.Animation.generateFrameNames('run-', 0, 3, '', 0), animVel - 4, true);
  this.animations.add('run-shoot', Phaser.Animation.generateFrameNames('run-shoot-', 0, 3, '', 0), animVel - 4, true);
  this.animations.add('jump', Phaser.Animation.generateFrameNames('jump-', 0, 5, '', 0), animVel - 4, true);
  this.animations.add('climb', Phaser.Animation.generateFrameNames('climb-', 0, 3, '', 0), animVel - 4, true);
